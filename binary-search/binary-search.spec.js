...
const test4 = [5, 3, 2.6, -3, -3.5, -3.777777, -5];
...
describe('Binary Search', () => {
	...
	it('for sorted lists in desceding order, it returns true if target value is in array', () => {
		expect(binarySearch(test4, 2.6)).to.equal(true);
	});

	it('for sorted lists in desceding order, it returns false if target value is not in array', () => {
